...
public class NewMustTryRestAdapter extends RecyclerView.Adapter<NewMustTryRestAdapter.ViewHolder> {
    ...
    public NewMustTryRestAdapter(Context c, ArrayList<RestaurantModel> freedeliveryrList, String city) {
        try
        {
            this.context = c;
    ...
    @Override
    public NewMustTryRestAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater;
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = layoutInflater.inflate(R.layout.freedeliverylayout, parent, false);
        return new NewMustTryRestAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final NewMustTryRestAdapter.ViewHolder holder, final int position) {
