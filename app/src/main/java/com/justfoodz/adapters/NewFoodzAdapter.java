...
public class NewFoodzAdapter extends RecyclerView.Adapter<NewFoodzAdapter.ViewHolder> {
    ...
    public NewFoodzAdapter(Context c, ArrayList<RestaurantModel> freedeliveryrList, String city) {
        try {
            this.context = c;
    ...
    @Override
    public NewFoodzAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater;
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = layoutInflater.inflate(R.layout.newfoodzlayout, parent, false);
        return new NewFoodzAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final NewFoodzAdapter.ViewHolder holder, final int position) {
