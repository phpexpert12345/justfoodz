...
public class Model_feature_restaurant  implements Serializable {
    ...
    public String getDeal_price_add() {
        return deal_price_add;
    }

    public void setDeal_price_add(String deal_price_add) {
    ...
    public void setRestaurantTimeStatusText(String restaurantTimeStatusText) {
        RestaurantTimeStatusText = restaurantTimeStatusText;
    }
