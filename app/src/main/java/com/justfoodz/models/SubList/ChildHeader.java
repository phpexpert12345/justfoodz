...
public class ChildHeader {
    String id,FoodItemID,FoodItemSizeID,Food_addonsselection,Food_Addons,Food_PriceAddons;


    public ChildHeader(String id,String FoodItemID,String FoodItemSizeID,String Food_addonsselection,String Food_Addons,String Food_PriceAddons)
    {
        this.id = id;
        this.FoodItemID = FoodItemID;
        this.FoodItemSizeID = FoodItemSizeID;
        this.Food_addonsselection = Food_addonsselection;
        this.Food_Addons = Food_Addons;
        this.Food_PriceAddons = Food_PriceAddons;
    }
